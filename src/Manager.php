<?php namespace CodeSPB\LaravelPodcastFeed;

// This class was inherited from torann/podcastfeed package and updated for the latest Laravel version comapiblity
use DateTime;
